...
- <Icon name="CheckCircle" size={18} className="text-primary" /> **AI generates everything**
...
- <Icon name="TrendingUp" size={16} className="text-primary" /> **Analyze modern portfolios** to
  identify patterns
- <Icon name="Palette" size={16} className="text-primary" /> **Gather information** about
...
<Icon name="Sparkles" size={18} className="text-primary" /> **Key decision**: I never used Opus.
...
<Icon name="Sparkles" size={16} className="text-primary" /> Implemented complex functionality: -
...
- <Icon name="Gauge" size={16} className="text-primary" /> **Lighthouse**: 96/100 (Performance: 100,
...
<Icon name="Cpu" size={16} className="text-primary" /> Not every task needs the most powerful model:
- **Planning & Research**: Gemini (web search) or Claude Opus - **Implementation**: Claude Sonnet
4.5 (with skills and MCPs) - **Simple edits**: Claude Haiku 4.5 (types, config, simple components)
...
- <Icon name="Check" size={16} className="text-primary" /> Design system architecture (with web
  research)
- <Icon name="Check" size={16} className="text-primary" /> Implement complex features (animations,
  MDX pipeline, dynamic routing)
- <Icon name="Check" size={16} className="text-primary" /> Write production-quality code
  (TypeScript, accessibility, performance)
- <Icon name="Check" size={16} className="text-primary" /> Create comprehensive content (technical
  writing, narratives)
- <Icon name="Check" size={16} className="text-primary" /> Optimize for performance (Lighthouse
  96/100)
