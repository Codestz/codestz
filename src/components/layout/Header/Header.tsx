    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-6">
          ...
          <div
            ref={navRef}
            className="flex gap-2 sm:gap-4 md:gap-6 lg:gap-10 font-bold uppercase tracking-tighter text-xs sm:text-sm md:text-base"
          >
            {navLinks.map((link) => (
              <Link
                key={link.href}
          ...
          <div className="md:hidden fixed inset-0 z-[100] bg-bg-elevated">
            <div className="flex flex-col h-full">
              ...
              <div className="flex justify-between items-center p-4 border-b-[3px] border-foreground">
                <span className="font-heading text-xl uppercase font-bold text-foreground">
                  Menu
                </span>
                <IconButton
